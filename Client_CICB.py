...
# Load dataset
i = 3
(X_train_3,y_train_3) = utils.load_credit_train_i_Default(i)
(X_test, y_test,y_test_p_3) = utils.load_credit_test_i_Default(i)
...
class MnistClient(fl.client.NumPyClient):
    ...
    def fit(self, parameters, config): # type: ignore
        ...
        print(accuracy)
        profit = utils.profit_evaluation(model.predict(X_test), y_test_p_3)
        print(profit)
